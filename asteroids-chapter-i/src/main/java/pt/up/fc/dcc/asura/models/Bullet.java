...
import pt.up.fc.dcc.asura.models.effects.BulletHitEffect;
...
public class Bullet extends Actor {
    ...
    public Bullet(String playerId, int teamNr, long startTime, int bulletCount, Vector position, Vector velocity,
                  int heading) {
